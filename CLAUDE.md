...
**Головна проблемна теза (гіпотеза):** активні туристи не мають проблеми «де забронювати одну річ» — у них проблема фрагментації планування. Маршрут, умови на місці (погода, доступ, складність), ночівля, спорядження й локальні активності живуть у різних застосунках, і немає одного місця, яке зводить план подорожі в ціле.
...
_TBD — визначити в фазі 1: конкурентний аудит (стартовий список: Komoot, AllTrails, Naturkartan, Hipcamp, Fishbrain, GetYourGuide/Airbnb Experiences), персони активних туристів, JTBD, карта болів, UX-патерни трип-планування й бронювання_
...
2. **Список конкурентів** для аудиту — підтвердити чи розширити стартовий список із §7
