...
**33 екранів · 1244 рядків тексту · 475 унікальних.** Це перепис того, що зараз написано в макетах, без жодної правки. До кінця роботи над флоу він має стати таблицею, з якою звіряється кожен рядок продукту.
...
| Застосунок | kristin@пошта · Apple | підпис |  |
| Застосунок | Акаунт | пункт списку |  |
...
Позначено 171 рядків із 953. Жодного не змінено.
