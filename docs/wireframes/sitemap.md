...
- **`lock-in` · 7.1. Останні кроки** · job 7 · **P**
...
- **`share` · 10.1. Сказати, куди йду** — два регістри: довіра близьких (10) і безпековий share, який рекомендує сам DNT · job 10 · P S
...
| 23 | **Хижа — самостійний обʼєкт, ніч — ні** | `hut` існує без дат: тип, ключ, ліжка, сезон, сусіди й відстані. `night` = хижа × дата × бронь × час приходу × членство. `huts` — один пошук на два контексти: з чого складається ланцюг при плануванні і що ще досяжне, коли ніч зривається в дорозі. Розрив у ланцюзі (`huts-empty`) — відповідь, а не порожній результат: «38 км до наступного даху — це не денний перехід» |
