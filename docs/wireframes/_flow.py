...
STEPS = [
 ...
 dict(
  ...
  branches=[
   ...
   ('зберегти', 'account.html', 'аркуш входу'),
 ...
 dict(
  file='account.html', rail='Вхід',
  jobs='7',
  lead='Замість екрана з поясненнями — аркуш входу: Apple, Google, пошта. Далі системний запит на сповіщення.',
  body='<p>Можна продовжити без входу — план лишиться на цьому телефоні.</p>',
  q='Увійшли?',
  branches=[
   ('так', 'plan.html', 'план у «Планах»'),
  ]),
 dict(
