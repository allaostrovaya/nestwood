...
flowchart TD
    ...
    plan --> transport["transport · Транспорт + збережені квитки"]
...
flowchart TD
    ...
    HANDM -.-> C1REF["lock-in · Що лишилось закріпити"]
...
```mermaid
flowchart TD
    IN(["План готовий, жодна ніч не закріплена"]) --> lock-in["lock-in · Що лишилось закріпити"]
...
flowchart TD
    ...
    QKIND -->|транспорт| transport["transport · Транспорт до старту й від фінішу"]
    ...
    QNEWSTEP -->|так| lock-in["lock-in · Що лишилось закріпити"]
    QNEWSTEP -->|ні| WIN2
...
flowchart TD
    ...
    plan --> share["share · Підсумок для передачі"]
    today --> share
