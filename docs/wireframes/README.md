...
Status: **complete — 20 screens + 13 states = 33 pages, nothing left grey.**
...
| 2 · Screen tree | [sitemap.md](./sitemap.md) § Екрани — five tabs, 20 screens, states, coverage both ways | **rewritten** |
...
| 5 · Traceability | [sitemap.md](./sitemap.md) § Трасування — 12 jobs × 20 screens + hypothesis H6, orphan lists with a decision each | **recomputed** |
| 6 · Wireframes | 33 pages · all 20 screens and their states | **done** — every named exit leads to a real screen |
