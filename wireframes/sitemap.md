...
- **`catalogue` · 0.1. Каталог** — карта Скандинавії + список маршрутів, перемикач «список / карта», фільтри чіпами · job MAIN, 1 · P S
...
- **`field-notes` · 11.2. Умови · нотатки з місця** — стан стежки, маркування, вода, броди, сніг · **розходження офіційних даних із місцевістю** (головна підстава) + 11, 1 · P S
...
- **`map` · 1.1. Повноекранна карта** — шари: маршрут, хижі за типом, точки сходу, транспорт, вода й броди · job 1, 2, 6 · P S
...
- **`plans` · —. Плани** — активний / майбутні / минулі, **бейдж «скільки закріпити»** · **[не-job: сховище]** · P
...
- **`night` · 2.1. Ніч: гарантія й доступ** — формула тип × бронь × час приходу × членство · job 2, 8 · P S
  *Тут же стан «наявність очікує угоди з DNT» і позначка мок-даних **на рядку наявності ліжок**.*
- **`nights` · 2.2. Ночівлі — ланцюжок** · job 2, 7 · P S
...
- **`transport` · 6.1. Транспорт** — до старту й від фінішу, **зі збереженими квитками** · job 6, 7 · P S
...
- **`changes` · 3.1. Що змінилось** · job 3, 6 · P S
...
- **`me` · 9.1. Про мене** — форма, вага, темп, членства; **імпорт зі Strava/Garmin** як фактичне джерело форми замість самооцінки · job 1, 2, 9 · P S
