...
└ Довідник            ← хаб             └ Безпека  ← хаб     └ Я  ← хаб
  └ Стаття                                └ Перша допомога     ├ Моє спорядження
                                                               ├ Членство й ключ
                                                               └ Налаштування
```
...
⚠️ **Дві перебудови 2026-09-23.** Флоу: **пошук → генерація → новий план → вхід → план → день**. Друга перебудова прибрала внутрішні тексти з усіх екранів, звела кожну задачу до однієї сутності й скоротила набір до 33 сторінок. Беклог і рішення по кожному пункту — `_next.md`.
...
- **`new-plan` · 0.2. Новий план** ⭐ — незбережений: «Скасувати» — зникає · job MAIN, 1, 2, 4, 6, 9, 11 · P S
  ...
  - маршрут (превʼю карти, км, набір, дні, найдовший день, градація) · що треба (членство, погода, спорядження, вартість) · дні — компактні рядки, статус тільки для винятків; тап → змінити ночівлю · нотатки й відгуки · «Зберегти план» → `account`
...
- **`account` · 7.3. Вхід** (аркуш) — Apple · Google · пошта; далі системний запит на сповіщення. Екрана «Попереджати про зміни» більше немає
