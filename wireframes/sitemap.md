...
- **`account` · 7.3. Вхід** (аркуш) — Apple · Google · пошта, далі системний запит на сповіщення. **Поза основним флоу** (2026-09-23): у демо акаунт уже є, тому «Зберегти план» веде одразу в план; вхід відкривається з «Я» · job 7 · P
