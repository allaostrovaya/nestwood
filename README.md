...
| Етап | Папка | Статус |
|---|---|---|
| Дослідження | [`research/`](research/) | 🟡 конкурентний аудит і бенчмарк закриті; персони, JTBD, карта болів, ринок/регуляторка — ні |
...
Порівняно за 5 осями (аудиторія, основа продукту, ключовий механізм, довіра, монетизація), зведено в 3 спільні патерни ринку, 3 відмінності, 3 відкриті питання до PM і спільний біль (фрагментація планування). 15 скріншотів у [`research/screens/`](research/screens/), реєстр — [`research/screens/INDEX.md`](research/screens/INDEX.md).

[`research/benchmark.md`](research/benchmark.md) — бенчмарк саме цього болю як виміру: 8 критеріїв оцінки (єдиний флоу, агрегація постачальників, контекстна релевантність, єдиний чекаут, гнучкість заміни, прозорість ціни, єдине місце, гарантія на пакет), 5 продуктів різних категорій (Expedia, Omio, G Adventures, Zola, Wanderlog), 3 механізми для MVP, 1 що не спрацює.
